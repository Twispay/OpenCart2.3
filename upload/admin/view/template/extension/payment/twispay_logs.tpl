    ...
    <div class="container-fluid">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <?php } else { ?>
                    ...
                    <?php foreach ($trans as $tran) { ?>
                            <tr>
                                ...
                                <td<?php if ($tran['status']=='complete-ok') {?><i class="refund fa fa-times red" aria-hidden="true" data-transid="<?php echo $tran['transactionId']; ?>" data-orderid="<?php echo $tran['order_id']; ?>" data-store="<?php echo $tran['store_id']; ?>"></i><?php } ?></td>
                ...
                <?php } ?>
                <!--<?php //echo $catalog; ?> <?php //echo $api_token; ?>-->
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    ...
    $(document).on('click', 'i.refund', function(){
        ...
        var refund = "<?php echo $refund; ?>"+'&user_token='+token;;
        setTimeout(function(){
                    ...
                    success: function(data){
                        if(data.refunded != 1){
                            alert(data.status);
                                    ...
                                    $.ajax({
                                        url: '<?php echo $catalog; ?>index.php?route=api/order/history&api_token=<?php echo $api_token; ?>&store_id='+storeid+'&order_id='+orderid,
                                        type: 'post',
                                        dataType: 'json',
